...
async def enable() -> None:
    """ Enables the WebAudio domain and starts sending context lifetime events. # noqa """
    ...



async def disable() -> None:
    """ Disables the WebAudio domain. # noqa """
    ...



async def get_realtime_data() -> None:
    """ Fetch the realtime data from the registered contexts. # noqa """
    ...
