...
async def disable() -> None:
    """ Disables the fetch domain. # noqa """
    ...
...
calls one of failRequest, fulfillRequest or continueRequest/continueWithAuth. # noqa """
    ...



async def fail_request() -> None:
    """ Causes the request to fail with specified reason. # noqa """
    ...



async def fulfill_request() -> None:
    """ Provides response to the request. # noqa """
    ...



async def continue_request() -> None:
    """ Continues the request, optionally modifying some of its parameters. # noqa """
    ...



async def continue_with_auth() -> None:
    """ Continues a request supplying authChallengeResponse following authRequired event. # noqa """
    ...
