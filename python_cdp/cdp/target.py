...
async def activate_target() -> None:
    """ Activates (focuses) the target. # noqa """
    ...



async def attach_to_target() -> None:
    """ Attaches to the target with given id. # noqa """
    ...



async def attach_to_browser_target() -> None:
    """ Attaches to the browser target, only uses flat sessionId mode. # noqa """
    ...



async def close_target() -> None:
    """ Closes the target. If the target is a page that gets closed too. # noqa """
    ...
...
async def create_target() -> None:
    """ Creates a new page. # noqa """
    ...



async def detach_from_target() -> None:
    """ Detaches session with given id. # noqa """
    ...
...
async def get_target_info() -> None:
    """ Returns information about a target. # noqa """
    ...



async def get_targets() -> None:
    """ Retrieves a list of available targets. # noqa """
    ...
...
`targetCreated/targetInfoChanged/targetDestroyed` events. # noqa """
    ...
