...
async def forcibly_purge_java_script_memory() -> None:
    """ Simulate OomIntervention by purging V8 memory. # noqa """
    ...



async def set_pressure_notifications_suppressed() -> None:
    """ Enable/disable suppressing memory pressure notifications in all processes. # noqa """
    ...



async def simulate_pressure_notification() -> None:
    """ Simulate a memory pressure notification in all processes. # noqa """
    ...



async def start_sampling() -> None:
    """ Start collecting native memory profile. # noqa """
    ...



async def stop_sampling() -> None:
    """ Stop collecting native memory profile. # noqa """
    ...
...
collected since renderer process startup. # noqa """
    ...
...
async def get_browser_sampling_profile() -> None:
    """ Retrieve native memory allocations profile
collected since browser process startup. # noqa """
    ...
