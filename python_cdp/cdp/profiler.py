...
garbage collection. # noqa """
    ...



async def set_sampling_interval() -> None:
    """ Changes CPU profiler sampling interval. Must be called before CPU profiles recording started. # noqa """
    ...
...
coverage needs to have started. # noqa """
    ...
