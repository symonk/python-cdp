...
async def collect_class_names_from_subtree() -> None:
    """ Collects class names for the node with given id and all of it's child nodes. # noqa """
    ...
...
objects, can be used for automation. # noqa """
    ...
...
async def disable() -> None:
    """ Disables DOM agent for the given page. # noqa """
    ...
...
async def enable() -> None:
    """ Enables DOM agent for the given page. # noqa """
    ...



async def focus() -> None:
    """ Focuses the given element. # noqa """
    ...



async def get_attributes() -> None:
    """ Returns attributes for the specified node. # noqa """
    ...



async def get_box_model() -> None:
    """ Returns boxes for the given node. # noqa """
    ...
...
might return multiple quads for inline nodes. # noqa """
    ...
...
Use DOMSnapshot.captureSnapshot instead. # noqa """
    ...



async def get_nodes_for_subtree_by_style() -> None:
    """ Finds nodes with a given computed style in a subtree. # noqa """
    ...
...
either returned or not. # noqa """
    ...



async def get_outer_html() -> None:
    """ Returns node's HTML markup. # noqa """
    ...



async def get_relayout_boundary() -> None:
    """ Returns the id of the nearest ancestor that is a relayout boundary. # noqa """
    ...
...
async def hide_highlight() -> None:
    """ Hides any highlight. # noqa """
    ...



async def highlight_node() -> None:
    """ Highlights DOM node. # noqa """
    ...



async def highlight_rect() -> None:
    """ Highlights given rectangle. # noqa """
    ...



async def mark_undoable_state() -> None:
    """ Marks last undoable state. # noqa """
    ...



async def move_to() -> None:
    """ Moves node into the new container, places it before the given anchor. # noqa """
    ...
...
async def push_node_by_path_to_frontend() -> None:
    """ Requests that the node is sent to the caller given its path. // FIXME, use XPath # noqa """
    ...



async def push_nodes_by_backend_ids_to_frontend() -> None:
    """ Requests that a batch of nodes is sent to the caller given their backend node ids. # noqa """
    ...
...
appear on top of all other content. # noqa """
    ...



async def redo() -> None:
    """ Re-does the last undone action. # noqa """
    ...



async def remove_attribute() -> None:
    """ Removes attribute with given name from an element with given id. # noqa """
    ...



async def remove_node() -> None:
    """ Removes node with given id. # noqa """
    ...
...
async def resolve_node() -> None:
    """ Resolves the JavaScript node object for a given NodeId or BackendNodeId. # noqa """
    ...



async def set_attribute_value() -> None:
    """ Sets attribute for an element with given id. # noqa """
    ...
...
attribute value and types in several attribute name/value pairs. # noqa """
    ...



async def set_file_input_files() -> None:
    """ Sets files for the given file input element. # noqa """
    ...



async def set_node_stack_traces_enabled() -> None:
    """ Sets if stack traces should be captured for Nodes. See `Node.getNodeStackTraces`. Default is disabled. # noqa """
    ...



async def get_node_stack_traces() -> None:
    """ Gets stack traces associated with a Node. As of now, only provides stack trace for Node creation. # noqa """
    ...
...
async def set_node_name() -> None:
    """ Sets node name for a node with given id. # noqa """
    ...



async def set_node_value() -> None:
    """ Sets node value for a node with given id. # noqa """
    ...



async def set_outer_html() -> None:
    """ Sets node HTML markup, returns new node id. # noqa """
    ...



async def undo() -> None:
    """ Undoes the last performed action. # noqa """
    ...



async def get_frame_owner() -> None:
    """ Returns iframe node that owns iframe with the given domain. # noqa """
    ...
...
container queries against this container. # noqa """
    ...
