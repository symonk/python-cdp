...
async def disable() -> None:
    """ Disables domain notifications. # noqa """
    ...



async def enable() -> None:
    """ Enables domain notifications. # noqa """
    ...
...
async def get_grid_highlight_objects_for_test() -> None:
    """ For Persistent Grid testing. # noqa """
    ...



async def get_source_order_highlight_object_for_test() -> None:
    """ For Source Order Viewer testing. # noqa """
    ...
...
objectId must be specified. # noqa """
    ...



async def highlight_quad() -> None:
    """ Highlights given quad. Coordinates are absolute with respect to the main frame viewport. # noqa """
    ...



async def highlight_rect() -> None:
    """ Highlights given rectangle. Coordinates are absolute with respect to the main frame viewport. # noqa """
    ...
...
JavaScript object wrapper. Either nodeId or objectId must be specified. # noqa """
    ...
...
Backend then generates 'inspectNodeRequested' event upon element selection. # noqa """
    ...



async def set_show_ad_highlights() -> None:
    """ Highlights owner element of all frames detected to be ads. # noqa """
    ...
...
async def set_show_grid_overlays() -> None:
    """ Highlight multiple elements with the CSS Grid overlay. # noqa """
    ...
...
async def set_show_hit_test_borders() -> None:
    """ Deprecated, no longer has any effect. # noqa """
    ...



async def set_show_web_vitals() -> None:
    """ Request that backend shows an overlay with web vital metrics. # noqa """
    ...



async def set_show_viewport_size_on_resize() -> None:
    """ Paints viewport size upon main frame resize. # noqa """
    ...
...
async def set_show_isolated_elements() -> None:
    """ Show elements in isolation mode with overlays. # noqa """
    ...
