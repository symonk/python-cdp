...
https://w3c.github.io/webdriver-bidi. """
    ...
    type: typing.List[typing.Literal['undefined', 'null', 'string', 'number', 'boolean', 'bigint', 'regexp', 'date', 'symbol', 'array', 'object', 'function', 'map', 'set', 'weakmap', 'weakset', 'error', 'proxy', 'promise', 'typedarray', 'arraybuffer', 'node', 'window']]
    # Description is missing from the devtools protocol document. # noqa
    value: typing.Any
    # Description is missing from the devtools protocol document. # noqa
...
class RemoteObject:
    ...
    # Object type. # noqa
    type: typing.List[typing.Literal['object', 'function', 'undefined', 'string', 'number', 'boolean', 'symbol', 'bigint']]
    ...
    subtype: typing.Optional[typing.List[typing.Literal['array', 'null', 'node', 'regexp', 'date', 'map', 'set', 'weakmap', 'weakset', 'iterator', 'generator', 'error', 'proxy', 'promise', 'typedarray', 'arraybuffer', 'dataview', 'webassemblymemory', 'wasmvalue']]]
...
class PropertyPreview:
    ...
    type: typing.List[typing.Literal['object', 'function', 'undefined', 'string', 'number', 'boolean', 'symbol', 'accessor', 'bigint']]
...
class ConsoleAPICalled:
    ...
    type: typing.Literal['log', 'debug', 'info', 'error', 'warning', 'dir', 'dirxml', 'table', 'trace', 'clear', 'start_group', 'start_group_collapsed', 'end_group', 'assert', 'profile', 'profile_end', 'count', 'time_end']
...
async def await_promise() -> None:
    """ Add handler to promise with given promise object id. # noqa """
    ...
...
inherited from the target object. # noqa """
    ...



async def compile_script() -> None:
    """ Compiles expression. # noqa """
    ...



async def disable() -> None:
    """ Disables reporting of execution contexts creation. # noqa """
    ...



async def discard_console_entries() -> None:
    """ Discards collected exceptions and console API calls. # noqa """
    ...
...
async def evaluate() -> None:
    """ Evaluates expression on global object. # noqa """
    ...



async def get_isolate_id() -> None:
    """ Returns the isolate id. # noqa """
    ...
...
async def global_lexical_scope_names() -> None:
    """ Returns all let, const and class variables from global scope. # noqa """
    ...
...
async def release_object() -> None:
    """ Releases remote object with given id. # noqa """
    ...



async def release_object_group() -> None:
    """ Releases all remote objects that belong to a given group. # noqa """
    ...



async def run_if_waiting_for_debugger() -> None:
    """ Tells inspected instance to run if it was waiting for debugger to attach. # noqa """
    ...



async def run_script() -> None:
    """ Runs script with given id in a given context. # noqa """
    ...



async def set_async_call_stack_depth() -> None:
    """ Enables or disables async call stacks tracking. # noqa """
    ...
...
Each binding function call produces Runtime.bindingCalled notification. # noqa """
    ...
...
unsubscribes current runtime agent from Runtime.bindingCalled notifications. # noqa """
    ...
