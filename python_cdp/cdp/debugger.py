...
class Scope:
    """ Scope description. """
    # Scope type. # noqa
    type: typing.List[typing.Literal['global', 'local', 'with', 'closure', 'catch', 'block', 'script', 'eval', 'module', 'wasm-expression-stack']]
...
class Paused:
    ...
    reason: typing.Literal['ambiguous', 'assert', 'csp_violation', 'debug_command', 'dom', 'event_listener', 'exception', 'instrumentation', 'oom', 'other', 'promise_rejection', 'xhr']
...
async def continue_to_location() -> None:
    """ Continues execution until specific location is reached. # noqa """
    ...



async def disable() -> None:
    """ Disables debugger for given page. # noqa """
    ...
...
enabled until the result for this command is received. # noqa """
    ...



async def evaluate_on_call_frame() -> None:
    """ Evaluates expression on a given call frame. # noqa """
    ...
...
async def get_script_source() -> None:
    """ Returns source for the script with given id. # noqa """
    ...
...
will return errors. # noqa """
    ...



async def get_wasm_bytecode() -> None:
    """ This command is deprecated. Use getScriptSource instead. # noqa """
    ...
...
async def pause() -> None:
    """ Stops on the next JavaScript statement. # noqa """
    ...
...
async def remove_breakpoint() -> None:
    """ Removes JavaScript breakpoint. # noqa """
    ...
...
async def resume() -> None:
    """ Resumes JavaScript execution. # noqa """
    ...



async def search_in_content() -> None:
    """ Searches for given string in script content. # noqa """
    ...
...
performing 'step in' several times, finally resorting to 'step out' if unsuccessful. # noqa """
    ...
...
blackboxed. Array should be sorted. # noqa """
    ...



async def set_breakpoint() -> None:
    """ Sets JavaScript breakpoint at a given location. # noqa """
    ...



async def set_instrumentation_breakpoint() -> None:
    """ Sets instrumentation breakpoint. # noqa """
    ...
...
async def set_breakpoints_active() -> None:
    """ Activates / deactivates all breakpoints on the page. # noqa """
    ...
...
async def set_return_value() -> None:
    """ Changes return value in top frame. Available only at return break position. # noqa """
    ...
...
async def set_skip_all_pauses() -> None:
    """ Makes page not interrupt on any pauses (breakpoint, exception, dom exception etc). # noqa """
    ...
...
mutated manually. # noqa """
    ...



async def step_into() -> None:
    """ Steps into the function call. # noqa """
    ...



async def step_out() -> None:
    """ Steps out of the function call. # noqa """
    ...



async def step_over() -> None:
    """ Steps over the statement. # noqa """
    ...
