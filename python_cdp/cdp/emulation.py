...
async def can_emulate() -> None:
    """ Tells whether emulation is supported. # noqa """
    ...
...
async def reset_page_scale_factor() -> None:
    """ Requests that page scale factor is reset to initial values. # noqa """
    ...



async def set_focus_emulation_enabled() -> None:
    """ Enables or disables simulating a focused and active page. # noqa """
    ...



async def set_auto_dark_mode_override() -> None:
    """ Automatically render all web contents using a dark theme. # noqa """
    ...



async def set_cpu_throttling_rate() -> None:
    """ Enables CPU throttling to emulate slow CPUs. # noqa """
    ...
...
if the content does not specify one. # noqa """
    ...
...
async def set_emulated_media() -> None:
    """ Emulates the given media type or media feature for CSS media queries. # noqa """
    ...



async def set_emulated_vision_deficiency() -> None:
    """ Emulates the given vision deficiency. # noqa """
    ...
...
async def set_idle_override() -> None:
    """ Overrides the Idle state. # noqa """
    ...



async def clear_idle_override() -> None:
    """ Clears Idle state overrides. # noqa """
    ...



async def set_navigator_overrides() -> None:
    """ Overrides value returned by the javascript navigator object. # noqa """
    ...



async def set_page_scale_factor() -> None:
    """ Sets a specified page scale factor. # noqa """
    ...



async def set_script_execution_disabled() -> None:
    """ Switches script execution in the page. # noqa """
    ...



async def set_touch_emulation_enabled() -> None:
    """ Enables touch on platforms which do not support them. # noqa """
    ...
...
the current virtual time policy.  Note this supersedes any previous time budget. # noqa """
    ...



async def set_locale_override() -> None:
    """ Overrides default host system locale with the specified one. # noqa """
    ...



async def set_timezone_override() -> None:
    """ Overrides default host system timezone with the specified one. # noqa """
    ...
...
async def set_automation_override() -> None:
    """ Allows overriding the automation flag. # noqa """
    ...
