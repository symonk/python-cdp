...
an |issueUpdated| event is fired. # noqa """
    ...



async def disable() -> None:
    """ Stops observing for sinks and issues. # noqa """
    ...
...
sink via Presentation API, Remote Playback API, or Cast SDK. # noqa """
    ...



async def start_desktop_mirroring() -> None:
    """ Starts mirroring the desktop to the sink. # noqa """
    ...



async def start_tab_mirroring() -> None:
    """ Starts mirroring the tab to the sink. # noqa """
    ...



async def stop_casting() -> None:
    """ Stops the active Cast session on the sink. # noqa """
    ...
