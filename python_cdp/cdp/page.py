...
class BackForwardCacheNotRestoredReason(str, enum.Enum):
    ...
    _ENTERED_BACK_FORWARD_CACHE_BEFORE_SERVICE_WORKER_HOST_ADDED = "entered_back_forward_cache_before_service_worker_host_added"
    ...
    _EMBEDDER_CHROME_PASSWORD_MANAGER_CLIENT_BIND_CREDENTIAL_MANAGER = "embedder_chrome_password_manager_client_bind_credential_manager"
...
async def add_script_to_evaluate_on_load() -> None:
    """ Deprecated, please use addScriptToEvaluateOnNewDocument instead. # noqa """
    ...



async def add_script_to_evaluate_on_new_document() -> None:
    """ Evaluates given script in every frame upon creation (before loading frame's scripts). # noqa """
    ...



async def bring_to_front() -> None:
    """ Brings page to front (activates tab). # noqa """
    ...



async def capture_screenshot() -> None:
    """ Capture page screenshot. # noqa """
    ...
...
iframes, shadow DOM, external resources, and element-inline styles. # noqa """
    ...



async def clear_device_metrics_override() -> None:
    """ Clears the overridden device metrics. # noqa """
    ...



async def clear_device_orientation_override() -> None:
    """ Clears the overridden Device Orientation. # noqa """
    ...



async def clear_geolocation_override() -> None:
    """ Clears the overridden Geolocation Position and Error. # noqa """
    ...



async def create_isolated_world() -> None:
    """ Creates an isolated world for the given frame. # noqa """
    ...



async def delete_cookie() -> None:
    """ Deletes browser cookie with given name, domain and path. # noqa """
    ...



async def disable() -> None:
    """ Disables page domain notifications. # noqa """
    ...



async def enable() -> None:
    """ Enables page domain notifications. # noqa """
    ...
...
async def get_manifest_icons() -> None:
    """ Deprecated because it's not guaranteed that the returned icon is in fact the one used for PWA installation. # noqa """
    ...
...
async def get_frame_tree() -> None:
    """ Returns present frame tree structure. # noqa """
    ...



async def get_layout_metrics() -> None:
    """ Returns metrics relating to the layouting of the page, such as viewport bounds/scale. # noqa """
    ...



async def get_navigation_history() -> None:
    """ Returns navigation history for the current page. # noqa """
    ...



async def reset_navigation_history() -> None:
    """ Resets navigation history for the current page. # noqa """
    ...



async def get_resource_content() -> None:
    """ Returns content of the given resource. # noqa """
    ...



async def get_resource_tree() -> None:
    """ Returns present frame / resource tree structure. # noqa """
    ...



async def handle_java_script_dialog() -> None:
    """ Accepts or dismisses a JavaScript initiated dialog (alert, confirm, prompt, or onbeforeunload). # noqa """
    ...



async def navigate() -> None:
    """ Navigates current page to the given URL. # noqa """
    ...



async def navigate_to_history_entry() -> None:
    """ Navigates current page to the given history entry. # noqa """
    ...



async def print_to_pdf() -> None:
    """ Print page as PDF. # noqa """
    ...



async def reload() -> None:
    """ Reloads given page optionally ignoring the cache. # noqa """
    ...



async def remove_script_to_evaluate_on_load() -> None:
    """ Deprecated, please use removeScriptToEvaluateOnNewDocument instead. # noqa """
    ...



async def remove_script_to_evaluate_on_new_document() -> None:
    """ Removes given script from the list. # noqa """
    ...



async def screencast_frame_ack() -> None:
    """ Acknowledges that a screencast frame has been received by the frontend. # noqa """
    ...



async def search_in_resource() -> None:
    """ Searches for given string in resource content. # noqa """
    ...



async def set_ad_blocking_enabled() -> None:
    """ Enable Chrome's experimental ad filter on all sites. # noqa """
    ...



async def set_bypass_csp() -> None:
    """ Enable page Content Security Policy by-passing. # noqa """
    ...



async def get_permissions_policy_state() -> None:
    """ Get Permissions Policy state on given frame. # noqa """
    ...



async def get_origin_trials() -> None:
    """ Get Origin Trials on given frame. # noqa """
    ...
...
async def set_device_orientation_override() -> None:
    """ Overrides the Device Orientation. # noqa """
    ...



async def set_font_families() -> None:
    """ Set generic font families. # noqa """
    ...



async def set_font_sizes() -> None:
    """ Set default font sizes. # noqa """
    ...



async def set_document_content() -> None:
    """ Sets given markup as the document's HTML. # noqa """
    ...
...
async def set_lifecycle_events_enabled() -> None:
    """ Controls whether page will emit lifecycle events. # noqa """
    ...



async def set_touch_emulation_enabled() -> None:
    """ Toggles mouse event-based touch event emulation. # noqa """
    ...
...
async def stop_loading() -> None:
    """ Force the page stop all navigations and pending resource fetches. # noqa """
    ...



async def crash() -> None:
    """ Crashes renderer on the IO thread, generates minidumps. # noqa """
    ...



async def close() -> None:
    """ Tries to close page, running its beforeunload hooks, if any. # noqa """
    ...
...
cross-process navigation. # noqa """
    ...



async def clear_compilation_cache() -> None:
    """ Clears seeded compilation cache. # noqa """
    ...
...
async def generate_test_report() -> None:
    """ Generates a report for testing. # noqa """
    ...



async def wait_for_debugger() -> None:
    """ Pauses page execution. Can be resumed using generic Runtime.runIfWaitingForDebugger. # noqa """
    ...
