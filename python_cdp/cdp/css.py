...
async def collect_class_names() -> None:
    """ Returns all class names from specified stylesheet. # noqa """
    ...
...
async def disable() -> None:
    """ Disables the CSS agent for the given page. # noqa """
    ...
...
enabled until the result of this command is received. # noqa """
    ...
...
async def get_media_queries() -> None:
    """ Returns all media queries parsed by the rendering engine. # noqa """
    ...
...
async def get_style_sheet_text() -> None:
    """ Returns the current textual content for a stylesheet. # noqa """
    ...
...
the full layer tree for the tree scope and their ordering. # noqa """
    ...
...
to the front-end, no updates will be issued for the node. # noqa """
    ...



async def take_computed_style_updates() -> None:
    """ Polls the next batch of computed style updates. # noqa """
    ...
...
async def set_keyframe_key() -> None:
    """ Modifies the keyframe rule key text. # noqa """
    ...



async def set_media_text() -> None:
    """ Modifies the rule selector. # noqa """
    ...



async def set_container_query_text() -> None:
    """ Modifies the expression of a container query. # noqa """
    ...



async def set_supports_text() -> None:
    """ Modifies the expression of a supports at-rule. # noqa """
    ...



async def set_scope_text() -> None:
    """ Modifies the expression of a scope at-rule. # noqa """
    ...
...
async def set_style_sheet_text() -> None:
    """ Sets the new stylesheet text. # noqa """
    ...



async def set_style_texts() -> None:
    """ Applies specified style edits one after another in the given order. # noqa """
    ...



async def start_rule_usage_tracking() -> None:
    """ Enables the selector recording. # noqa """
    ...
...
instrumentation). # noqa """
    ...



async def set_local_fonts_enabled() -> None:
    """ Enables/disables rendering of local CSS fonts (enabled by default). # noqa """
    ...
